...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func setNavigation(navigationBar: UINavigationBar) {
    ...
    appearance.titleTextAttributes = [.foregroundColor: ApplicationDependency.manager.currentTheme.colors.white]
    appearance.largeTitleTextAttributes = [.foregroundColor: ApplicationDependency.manager.currentTheme.colors.white]
